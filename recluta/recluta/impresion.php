...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/Impresion.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
...
<div class="wrap">
	<div class="homeCont">
        ...
        <h1><?PHP echo $core["sesion"]->getVariable("sesion_reporte"); ?></h1>
        <table class="reportes">
                	...
                	<?PHP
						foreach ($tabla as $indice => $elemento) {
							...
							for ($x=0; $x<count($cabecera); $x++) {
								echo "<td>" . strtoupper($cabecera[$x]) . "</td>";
							}
            ...
            <tbody>
            	<?PHP foreach ($tabla as $indice => $elemento) { ?>
                	<tr>
                    	<?PHP
						echo "<td>" . ($indice + 1) . "</td>";
                    	for ($x=0; $x<count($cabecera); $x++) {
                            echo "<td>" . $elemento[$cabecera[$x]] . "</td>";
                        }
						?>
                    </tr>
                <?PHP } ?>

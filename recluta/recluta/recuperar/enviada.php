<?PHP
	...
	$correo = $core["sesion"]->getVariable("campo_correo");
	$core["sesion"]->setVariable("campo_correo", "");
        ...
        <div class="izquierda">
            <div class="contenido">
              <!-- InstanceBeginEditable name="Contenido" -->
					<h1>Recuperación Enviada</h1>
                    <p>El correo fue enviado exitosamente a <strong><?PHP echo $correo; ?></strong></p>
					<!-- InstanceEndEditable -->
            </div>
        </div>
        <div class="derecha">
        	<div class="opciones">
                <!-- InstanceBeginEditable name="Opciones" -->
                    <h1>Instrucciones</h1>
                    <ol>
                    	<li>Abra su bandeja de correo y haga clic en la liga que le fue enviada.</li>
                    </ol>
					<!-- InstanceEndEditable -->
            </div>
        </div>

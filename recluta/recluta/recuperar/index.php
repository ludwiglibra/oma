<?PHP
	...
	/* Establecer Memoria de Contenidos */
        ...
        <div class="izquierda">
            <div class="contenido">
              <!-- InstanceBeginEditable name="Contenido" -->
                    ...
                    <form name="frmRecuperar" method="post" action="recuperar.php">
                    	<table class="detalles">
                            ...
                            <tfoot>
                            	<tr>
                                	<td colspan="2">
                                    	<input type="submit" name="btnRecuperar" value="Recuperar" />
        ...
        <div class="derecha">
        	<div class="opciones">
                <!-- InstanceBeginEditable name="Opciones" -->
                    <h1>Instrucciones</h1>
                    <ol>
                    	<li>Indique su cuenta de correo electrónico, haga clic en el botón <strong>RECUPERAR</strong> y siga las instrucciones que le serán indicadas.</li>
                    </ol>
                    <em>Los campos marcados con asterisco (*) son obligatorios.</em>
                    <em>Considere que al presionar el botón RECUPERAR, la cuenta asociada al correo electrónico será inhabilitada por seguridad y sólo volverá a ser habilitada una vez que se complete el proceso de recuperación o mediante la intervención del administrador del sitio.</em>
					<!-- InstanceEndEditable -->
            </div>
        </div>
        <div class="clear"></div>

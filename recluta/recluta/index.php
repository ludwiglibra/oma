<?PHP
	...
	$listado_vacantes = $core["vacantes"]->ListadoVigentes();
	$listado_imagenes = $core["imagenes"]->ListadoActivos();
            ...
            <?PHP if ($sesion_registrada) { ?>
                    ...
                    <div class="nav">
                        ...
                        <div class="inicioHover">
                            ...
                            <div class="inicioSubmenu navSub">
                                <a href="modulos/autoservicio/generales/">Mis Datos Generales</a>
                                <a href="modulos/autoservicio/candidato/">Mis Datos de Candidato</a>
                                <a href="modulos/autoservicio/cambio/">Cambio de Contraseña</a>
                                <a href="modulos/autoservicio/accesos/">Mis Accesos al Sistema</a>
                        ...
                        <div class="formatosHover">
                            ...
                            <div class="formatosSubmenu navSub subnormal">
                            	<a href="modulos/administracion/parametros/">Parámetros del Sistema</a>
                                <a href="modulos/administracion/areas/">Áreas de la Organización</a>
                                <a href="modulos/administracion/usuarios/">Control de Usuarios</a>
                                <a href="modulos/administracion/accesos/">Registro de Accesos</a>
                                <a href="modulos/administracion/imagenes/">Imágenes de Banner</a>
                                <a href="modulos/administracion/informatica/">Conocimientos Informática</a>
                                <a href="modulos/administracion/industrias/">Catálogo Industrias</a>
                                <a href="modulos/administracion/errores/">Monitor Errores SQL</a>
                            </div>
                        </div>
                        ...
                        <div class="centroHover">
                            ...
                            <div class="centroSubmenu navSub subnormal">
                                <a href="modulos/bolsa/vacantes/agregar/">Creación de Vacante</a>
                                <a href="modulos/bolsa/vacantes/">Administración de Vacantes</a>
                                <a href="modulos/bolsa/candidatos/">Control de Candidatos</a>
                            </div>
                        </div>
                        ...
                        <div class="sitiosHover">
                            ...
                            <div class="sitiosSubmenu navSub subnormal">
                            	<a href="modulos/evaluaciones/evaluaciones/agregar/">Crear Evaluación Técnica</a>
                            	<a href="modulos/evaluaciones/baterias/agregar/">Crear Batería de Evaluaciones</a>
                                <a href="modulos/evaluaciones/evaluaciones/">Administrar Evaluaciones</a>
                                <a href="modulos/evaluaciones/baterias/">Administrar Baterías de Evaluaciones</a>
                            </div>
                        </div>
				...
				<?PHP } elseif($sesion_nivel == 3) { ?>
                    ...
                    <div class="nav">
                        ...
                        <div class="sitiosHover">
                            <a href="modulos/candidatos/vacantes/" class="btnSitios">&nbsp;&nbsp;&nbsp;&nbsp;Vacantes&nbsp;&nbsp;&nbsp;&nbsp;</a>
                        </div>
    	...
    	<?PHP if ($sesion_registrada) { ?>
                        ...
                        <div class="flexslider">
                            <ul class="slides">
                            	...
                            	<?PHP
									...
									foreach ($listado_imagenes as $indice_imagen => $imagen) {
								...
								?>
                                    ...
                                    <li>
										...
										<?PHP if ($imagen["liga"] != "") { ?>
	                                        <a href="<?PHP echo $imagen["liga"]; ?>" target="_blank"><img src="modulos/administracion/imagenes/archivos/<?PHP echo $imagen["archivo"]; ?>"/></a>
                                        <?PHP } else { ?>
                                        	<img src="modulos/administracion/imagenes/archivos/<?PHP echo $imagen["archivo"]; ?>"/>
                                        <?PHP } ?>
                                        
                                        <p class="flex-caption"><?PHP echo $imagen["titulo"]; ?></p>
            ...
            <div class="derecha">
            	<div class="opciones">
                    ...
                    <h1><a href="modulos/candidatos/vacantes/">Vacantes Vigentes OMA</a></h1>
                    <div class="lstvacantes">
                    	<ul>
                        	<?PHP foreach ($listado_vacantes as $indice => $elemento) { ?>
                            	<li><a href="modulos/candidatos/vacantes/abrir.php?vacante=<?PHP echo $elemento["vacante"]; ?>"><strong><?PHP echo $elemento["titulo"]; ?></strong><?PHP echo $elemento["descripcion"]; ?></a></li>
                        	<?PHP } ?>
                        </ul>
                    </div>
					<!-- InstanceEndEditable -->

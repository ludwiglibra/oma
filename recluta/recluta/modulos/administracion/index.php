            ...
            <div class="izquierda">                
                <div class="contenido">
                  <!-- InstanceBeginEditable name="Contenido" -->
                        ...
                        <p>Administración de las opciones del sistema, como el control de los usuarios, las áreas de la organización, los usuarios asignados a cada área y los parámetros del sistema.</p>
                        <p>Elija una de las opciones de la barra derecha, para comenzar a trabajar.</p>
						<!-- InstanceEndEditable -->
                </div>
            </div>
            <div class="derecha">

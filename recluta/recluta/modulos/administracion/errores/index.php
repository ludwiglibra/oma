<?PHP
	...
	$listado_errores = $core["listados"]->ErroresSQL();
	
	$core["sesion"]->setVariable("sesion_reporte", "Errores SQL");
	$core["sesion"]->setVariable("sesion_datos", $listado_errores);
                ...
                <div class="contenido">
                  <!-- InstanceBeginEditable name="Contenido" -->
                        ...
                        <table class="reportes">
                            ...
                            <tbody>
                            	<?PHP foreach ($listado_errores as $indice => $elemento) { ?>
                            	<tr>
                                	<td><?PHP echo $indice + 1; ?></td>
                                    <td><?PHP echo $elemento["instante"]; ?></td>
                                    <td><?PHP echo $elemento["error"]; ?></td>
                                    <td><?PHP echo $elemento["sentencia"]; ?></td>
                                </tr>
								<?PHP } ?>
                            </tbody>
                        </table>

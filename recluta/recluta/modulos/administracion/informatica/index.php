<?PHP
	...
	$listado_informatica = $core["listados"]->ListadoInformatica($busqueda);
                            ...
                            <tbody>
                            	<?PHP foreach ($listado_informatica as $indice => $elemento) { ?>
                                    <tr>
                                        ...
                                        <td><?PHP echo $elemento["conocimiento"]; ?></td>
                                        <td><a href="eliminar.php?area=<?PHP echo $elemento["area"]; ?>&conocimiento=<?PHP echo $elemento["conocimiento"]; ?>"><img src="../../../imgs/acciones/borrar.png" alt="Eliminar Registro" title="Eliminar Registro" /></a></td>
                                    </tr>
								<?PHP } ?>
                            </tbody>
                        </table>
            ...
            <div class="derecha">
            	<div class="opciones">
                    <!-- InstanceBeginEditable name="Opciones" -->
                        <h1>Instrucciones</h1>
                        <ol>
                        	<li>Haga click sobre el botón AGREGAR para agregar una nueva área de la organización, o</li>
                            <li>Haga click sobre un nombre de área, para abrir los detalles del área en cuestión.</li>
                        </ol>
						<!-- InstanceEndEditable -->
                </div>
            </div>

    	...
    	<?PHP if ($sesion_registrada) { ?>
            ...
            <div class="izquierda">                
                <div class="contenido">
                  ...
                  <h1>Agregar Conocimiento de Informática</h1>
                  <form name="frmAgregar" method="post" action="agregar.php">
                    	<table class="detalles">
                        	<tbody>
                            	<tr>
                                	<td class="obligatorio">* Área Existente</td>
                                    <?PHP
									
										$listado_informatica = $core["listados"]->AreasInformatica();
									
									?>
                                    <td class="campo">
                                    	<select name="existente">
                                        	<option value=""></option>
                                            <?PHP foreach ($listado_informatica as $indice => $elemento) { ?>
                                            	<option value="<?PHP echo $elemento["area"]; ?>"><?PHP echo $elemento["area"]; ?></option>
                                            <?PHP } ?>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                	<td class="obligatorio">* Área Nueva</td>
                                    <td class="campo"><input type="text" name="nueva" value="" size="50" maxlength="50" /></td>
                                </tr>
                            	<tr>
                                	<td class="obligatorio">* Conocimiento</td>
                                    <td class="campo"><input type="text" name="conocimiento" value="" size="50" /></td>
                                </tr>
                            </tbody>
                            <tfoot>
                            	<tr>
            ...
            <div class="derecha">
            	<div class="opciones">
                    ...
                    <h1>Instrucciones</h1>
                    <ol>
                    	<li>Proporcione ID del área de la organización que se desea crear.</li>
                        <li>Introduzca la descripción del área de la organización.</li>
                        <li>Haga click en el botón <strong>AGREGAR</strong> para crear el área organizacional indicado o en el botón <strong>CANCELAR</strong> para regresar al listado de áreas de la organización.</li>
                    </ol>
					<!-- InstanceEndEditable -->
                </div>
            </div>

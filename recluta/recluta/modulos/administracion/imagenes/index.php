<?PHP
	...
	$core["sesion"]->setVariable("imagen_seleccionada", "");
	
	$busqueda = (isset($_POST["busqueda"]) && $_POST["busqueda"] != "") ? $_POST["busqueda"] : "";
	
	$listado_imagenes = $core["imagenes"]->ListadoTotal($busqueda);
            ...
            <div class="izquierda">                
                <div class="contenido">
                  <!-- InstanceBeginEditable name="Contenido" -->
                        <h1>Control de Imágenes de Banner</h1>
                        ...
                        <table class="reportes">
                            ...
                            <tbody>
                            	<?PHP foreach ($listado_imagenes as $indice => $elemento) { ?>
                                    <tr>
                                        <td><?PHP echo $indice + 1; ?></td>
                                        <td><a href="abrir.php?imagen=<?PHP echo $elemento["imagen"]; ?>"><?PHP echo $elemento["imagen"]; ?></a></td>
                                        <td><?PHP echo $elemento["titulo"]; ?></td>
                                        <td><?PHP echo $elemento["liga"]; ?></td>
                                        <td><?PHP echo $elemento["activo"]; ?></td>
                                        <td><a href="#" onclick=EliminarImagen('<?PHP echo $elemento["imagen"]; ?>'); ><img src="../../../imgs/acciones/borrar.png" alt="Eliminar Imagen" title="Eliminar Imagen" /></a></td>
                                    </tr>
								<?PHP } ?>
                            </tbody>
                        </table>
            ...
            <div class="derecha">
            	<div class="opciones">
                    <!-- InstanceBeginEditable name="Opciones" -->
                        <h1>Instrucciones</h1>
                        <ol>
                        	<li>Haga click sobre el botón AGREGAR para agregar un nuevo usuario, o</li>
                            <li>Haga click sobre un nombre de usuario, para abrir los detalles del usuario en cuestión.</li>
                        </ol>
						<!-- InstanceEndEditable -->
                </div>
            </div>

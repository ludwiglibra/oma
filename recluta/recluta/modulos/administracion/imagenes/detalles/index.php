<?PHP
	...
	$imagen_seleccionada= $core["sesion"]->getVariable("imagen_seleccionada");
	
	if ($imagen_seleccionada != "") {
			
		$core["imagenes"]->setImagen($imagen_seleccionada);
    	...
    	<?PHP if ($sesion_registrada) { ?>
            ...
            <div class="izquierda">                
                <div class="contenido">
                  ...
                  <h1>Detalles de Imagen <strong><?PHP echo strtoupper($imagen_seleccionada); ?></strong></h1>
                  <form name="frmDatos" method="post" action="actualizar.php">
                    	<table class="detalles">
                        	<tbody>
                            	<tr>
                                	<td class="obligatorio">* ID de Imagen</td>
                                    <td class="campo"><input type="text" name="imagen" value="<?PHP echo $core["imagenes"]->getImagen(); ?>" size="50" maxlength="50" readonly="readonly" class="llave" /></td>
                                </tr>
                            	<tr>
                                	<td class="obligatorio">* Título</td>
                                    <td class="campo"><input type="text" name="titulo" value="<?PHP echo $core["imagenes"]->getTitulo(); ?>" size="70" max="100" /></td>
                                </tr>
                                <tr>
                                	<td class="obligatorio">Descripción</td>
                                    <td class="campo"><textarea name="descripcion" cols="60" rows="10"><?PHP echo $core["imagenes"]->getDescripcion(); ?></textarea></td>
                                </tr>
                                <tr>
                                	<td class="obligatorio">Liga</td>
                                    <td class="campo"><textarea name="liga" cols="60" rows="10"><?PHP echo $core["imagenes"]->getLiga(); ?></textarea></td>
                                </tr>
                                <tr>
                                	<td class="obligatorio">* Archivo</td>
                                    <td class="campo">
                                    	<img src="../archivos/<?PHP echo $core["imagenes"]->getArchivo(); ?>" width="100%" />
                                    </td>
                                </tr>
                                <tr>
                                	<td class="obligatorio">Imagen Activa</td>
                                    <td class="campo">
                                    	<?PHP if ($core["imagenes"]->getActivo() == "X") { ?>

<?PHP
	...
	$campo_liga = $core["sesion"]->getVariable("campo_liga");
    	...
    	<?PHP if ($sesion_registrada) { ?>
            ...
            <div class="izquierda">                
                <div class="contenido">
                  ...
                  <h1>Agregar Imagen de Banner</h1>
                  <form name="frmAgregar" method="post" action="agregar.php" enctype="multipart/form-data">
                    	<table class="detalles">
                        	<tbody>
                            	<tr>
                                	<td class="obligatorio">* Titulo</td>
                            	...
                            	<tr>
                                    ...
                                    <td class="campo"><textarea name="descripcion" cols="60" rows="10"><?PHP echo $campo_descripcion; ?></textarea></td>
                                </tr>
                                <tr>
                                	<td class="obligatorio">Liga</td>
                                    <td class="campo"><textarea name="liga" cols="60" rows="10"><?PHP echo $campo_liga; ?></textarea></td>
                                </tr>
                                <tr>
                                	<td class="obligatorio">* Archivo</td>
                                    <td class="campo"><input type="file" name="archivo" /></td>
                                </tr>
                            </tbody>
                            <tfoot>
                            	<tr>
            ...
            <div class="derecha">
            	<div class="opciones">
                    ...
                    <h1>Instrucciones</h1>
                    <ol>
                    	<li>Indique el ID del Usuario que desea agregar.</li>
                    	<li>Proporcione nombre y correo electrónico.</li>
                        <li>Introduzca la clave que tendrá el usuario para el acceso al sistema.</li>
                        <li>Indique el nivel que debe tener el usuario.</li>
                        <li>Haga click en el botón <strong>AGREGAR</strong> para crear el usuario o en el botón <strong>CANCELAR</strong> para regresar al listado de usuarios.</li>
                    </ol>
					<!-- InstanceEndEditable -->
                </div>
            </div>

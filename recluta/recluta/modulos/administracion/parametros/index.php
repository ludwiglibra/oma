<?PHP
	...
	$listado_usuarios = $core["listados"]->UsuariosActivos();
            ...
            <div class="izquierda">                
                <div class="contenido">
                  <!-- InstanceBeginEditable name="Contenido" -->
                        ...
                        <form name="frmParametros" method="post" action="actualizar.php">
                    	<table class="detalles">
                        	<tbody>
                            	<tr>
                                	<td class="obligatorio">* Mensaje Legal</td>
                                    <td class="campo"><input type="text" name="mensaje" value="<?PHP echo $core["parametros"]->getMensaje(); ?>" size="50" maxlength="70" /></td>
                                </tr>
                                <tr>
                                	<td class="obligatorio">* Correo de Contacto</td>
                                    <td class="campo"><input type="text" name="contacto" value="<?PHP echo $core["parametros"]->getContacto(); ?>" size="50" maxlength="100" /></td>
                                </tr>
                                <tr>
                                	<td class="obligatorio">* Usuario Administrador</td>
                                    <td class="campo">
                                    	<select name="administrador">
                                        	<?PHP foreach ($listado_usuarios as $indice => $elemento) { ?>
                                            	<?PHP if ($elemento["usuario"] == $core["parametros"]->getAdministrador()) { ?>
                                                	<option value="<?PHP echo $elemento["usuario"]; ?>" selected="selected">
                                                <?PHP } else { ?>
                                        			<option value="<?PHP echo $elemento["usuario"]; ?>">
                                                <?PHP } ?>
                                                <?PHP echo $elemento["nombre"] . " (" . $elemento["usuario"] . ")"; ?>
                                                </option>
                                            <?PHP } ?>
                                        </select>
                                    </td>
                                ...
                                <tr>
                                	<td class="obligatorio">* Texto Psicométrico</td>
                                    <td class="campo"><textarea name="psicometrico" cols="60" rows="10"><?PHP echo $core["parametros"]->getPsicometrico(); ?></textarea></td>
                                </tr>
                                <tr>
                                	<td class="obligatorio">* Texto Aviso de Protección de Datos Personales</td>
                                    <td class="campo"><textarea name="aviso" cols="60" rows="10"><?PHP echo $core["parametros"]->getAviso(); ?></textarea></td>
                                </tr>
                                <tr>
                                	<td class="obligatorio">* Texto Genérico Correo Agradecimiento</td>
                                    <td class="campo"><textarea name="agradecimiento" cols="60" rows="10"><?PHP echo $core["parametros"]->getAgradecimiento(); ?></textarea></td>
                                </tr>
                            </tbody>
                            <tfoot>
                            	<tr>

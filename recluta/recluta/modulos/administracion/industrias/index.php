<?PHP
	...
	$listado_industrias = $core["listados"]->CatalogoIndustrias($busqueda);
                ...
                <div class="contenido">
                  <!-- InstanceBeginEditable name="Contenido" -->
                        ...
                        <table class="reportes">
                            ...
                            <tbody>
                            	<?PHP foreach ($listado_industrias as $indice => $elemento) { ?>
                                    <tr>
                                        <td><?PHP echo $indice + 1; ?></td>
                                        <td><?PHP echo $elemento["industria"]; ?></td>
                                        <td><a href="eliminar.php?industria=<?PHP echo $elemento["industria"]; ?>"><img src="../../../imgs/acciones/borrar.png" alt="Eliminar Registro" title="Eliminar Registro" /></a></td>
                                    </tr>
								<?PHP } ?>
                            </tbody>
                        </table>

<?PHP
	...
	$core["sesion"]->setVariable("area_seleccionada", "");
	
	$busqueda = (isset($_POST["busqueda"]) && $_POST["busqueda"] != "") ? $_POST["busqueda"] : "";
	
	$listado_areas = $core["areas"]->ListadoTotal($busqueda);
                            ...
                            <tbody>
                            	<?PHP foreach ($listado_areas as $indice => $elemento) { ?>
                                    <tr>
                                        ...
                                        <td><a href="abrir.php?area=<?PHP echo $elemento["area"]; ?>"><?PHP echo $elemento["area"]; ?></a></td>

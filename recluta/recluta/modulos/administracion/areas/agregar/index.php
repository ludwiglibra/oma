    	...
    	<?PHP if ($sesion_registrada) { ?>
            ...
            <div class="izquierda">                
                <div class="contenido">
                  ...
                  <h1>Agregar Área de la Organización</h1>
                  <form name="frmAgregar" method="post" action="agregar.php">
                    	<table class="detalles">
                        	<tbody>
                            	<tr>
                                	<td class="obligatorio">* ID Área</td>
                                    <td class="campo"><input type="text" name="area" value="" size="50" maxlength="50" /></td>
                                </tr>
                            	<tr>
                                	<td class="obligatorio">* Descripción</td>
                                    <td class="campo"><input type="text" name="descripcion" value="" size="50" /></td>
                                </tr>
                            </tbody>
                            <tfoot>
                            	<tr>

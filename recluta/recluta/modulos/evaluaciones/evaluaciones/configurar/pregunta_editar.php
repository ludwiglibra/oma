<?PHP
	...
	if ($evaluacion != "" && $pregunta != "") {
		...
		$core["sesion"]->setMensaje("No existen las condiciones mínimas para ver el detalle de una Pregunta de Evaluación Técnica.");
		header("location: " . $pagina);
		exit;
	}
	...
	<div class="homeCont">
    	...
    	<?PHP if ($sesion_registrada) { ?>
            ...
            <div class="izquierda">                
                ...
                <h1>Editar Pregunta de la Evaluación <strong><?PHP echo strtoupper($evaluacion); ?></strong></h1>
                <form name="frmEditar" method="post" action="pregunta_actualizar.php">
				<table class="detalles">
                    <tbody>
                        <tr>
                            <td class="obligatorio">* ID Evaluación</td>
                            <td class="campo"><input type="text" name="evaluacion" value="<?PHP echo $core["preguntas"]->getEvaluacion(); ?>" size="50" maxlength="100" readonly="readonly" class="llave" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="obligatorio">* Texto de la Pregunta</td>
                            <td class="campo"><textarea name="texto" cols="60" rows="8"><?PHP echo $core["preguntas"]->getTexto(); ?></textarea></td>
                        </tr>
                        <tr>
                            <td class="obligatorio">Pregunta Abierta</td>
                            <td class="campo">
                                <?PHP if ($core["preguntas"]->getAbierta() == "X") { ?>
                                    <input type="checkbox" name="abierta" value="X" checked="checked" />
                                <?PHP } else { ?>
                                    <input type="checkbox" name="abierta" value="X" />
                                <?PHP } ?>
                            </td>
                        </tr>
                    </tbody>

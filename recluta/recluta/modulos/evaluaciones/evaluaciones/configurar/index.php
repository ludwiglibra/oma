<?PHP
	...
	$evaluacion_seleccionada = $core["sesion"]->getVariable("evaluacion_seleccionada");
	
	if ($evaluacion_seleccionada != "") {
			
		if ($core["evaluaciones"]->Existe($evaluacion_seleccionada)) {
			
			$core["evaluaciones"]->setEvaluacion($evaluacion_seleccionada);
		...
		$core["sesion"]->setMensaje("No existen las condiciones mínimas para ver el detalle de una Evaluación Técnica.");
		header("location: " . $pagina);
		exit;
	}
	...
	<div class="homeCont">
    	...
    	<?PHP if ($sesion_registrada) { ?>
            ...
            <div class="izquierda">                
				...
				<h1>Configurar Evaluación <strong><?PHP echo strtoupper($evaluacion_seleccionada); ?></strong></h1>
                ...
                <table class="evaluacion">
                	...
                	<thead>
                    	<tr>
                        	<td class="opciones">
                            	<img src="../../../../imgs/evaluaciones/espaciar.png" />
                                <img src="../../../../imgs/evaluaciones/espaciar.png" />
                                <img src="../../../../imgs/evaluaciones/espaciar.png" />
                                <img src="../../../../imgs/evaluaciones/espaciar.png" />
                            	<a href="pregunta_agregar.php?evaluacion=<?PHP echo $core["evaluaciones"]->getEvaluacion(); ?>"><img src="../../../../imgs/evaluaciones/agregar.png" alt="Agregar Pregunta" title="Agregar Pregunta" /></a>
                            </td>
                            <td class="texto" colspan="4" >
                            	<?PHP echo $core["evaluaciones"]->getTitulo(); ?>
                            </td>
                        </tr>
                    </thead>
                    ...
                    <tbody>
						...
						<?PHP
                            ...
                            $core["preguntas"]->setEvaluacion($core["evaluaciones"]->getEvaluacion());
                            $listado_preguntas = $core["preguntas"]->ListadoTotal();
                            
                            foreach ($listado_preguntas as $indice => $pregunta) {
                        ...
                        ?>
                            ...
                            <tr>
                                <td class="opciones">
                                    ...
                                    <?PHP if (count($listado_preguntas) != $pregunta["pregunta"]) { ?>
                                        <a href="pregunta_bajar.php?evaluacion=<?PHP echo $core["evaluaciones"]->getEvaluacion(); ?>&pregunta=<?PHP echo $pregunta["pregunta"]; ?>"><img src="../../../../imgs/evaluaciones/bajar.png" alt="Bajar Pregunta" title="Bajar Pregunta" /></a>
                                    <?PHP } else { ?>
                                        <img src="../../../../imgs/evaluaciones/espaciar.png" />
                                    <?PHP } ?>
                                    
                                    <?PHP if ($pregunta["pregunta"] != 1) { ?>
                                        <a href="pregunta_subir.php?evaluacion=<?PHP echo $core["evaluaciones"]->getEvaluacion(); ?>&pregunta=<?PHP echo $pregunta["pregunta"]; ?>"><img src="../../../../imgs/evaluaciones/subir.png" alt="Subir Pregunta" title="Subir Pregunta" /></a>
                                    <?PHP } else { ?>
                                        <img src="../../../../imgs/evaluaciones/espaciar.png" />
                                    <?PHP } ?>
                                    
                                    <a href="pregunta_editar.php?evaluacion=<?PHP echo $core["evaluaciones"]->getEvaluacion(); ?>&pregunta=<?PHP echo $pregunta["pregunta"]; ?>"><img src="../../../../imgs/evaluaciones/editar.png" alt="Editar Pregunta" title="Editar Pregunta" /></a>
                                    
                                    <?PHP if ($pregunta["activo"] == "X") { ?>
                                        <a href="pregunta_desactivar.php?evaluacion=<?PHP echo $core["evaluaciones"]->getEvaluacion(); ?>&pregunta=<?PHP echo $pregunta["pregunta"]; ?>"><img src="../../../../imgs/evaluaciones/desactivar.png" alt="Desactivar Pregunta" title="Desactivar Pregunta" /></a>
                                    <?PHP } else { ?>
                                        <a href="pregunta_activar.php?evaluacion=<?PHP echo $core["evaluaciones"]->getEvaluacion(); ?>&pregunta=<?PHP echo $pregunta["pregunta"]; ?>"><img src="../../../../imgs/evaluaciones/activar.png" alt="Activar Pregunta" title="Activar Pregunta" /></a>
                                    <?PHP } ?>
        							
                                    <?PHP if ($pregunta["abierta"] != "X") { ?>
	                                    <a href="respuesta_agregar.php?evaluacion=<?PHP echo $core["evaluaciones"]->getEvaluacion(); ?>&pregunta=<?PHP echo $pregunta["pregunta"]; ?>"><img src="../../../../imgs/evaluaciones/agregar.png" alt="Agregar Respuesta" title="Agregar Respuesta" /></a>
									<?PHP } else { ?>
                                    	<img src="../../../../imgs/evaluaciones/espaciar.png" />
									<?PHP } ?>
                            ...
                            <?PHP
                                ...
                                $core["respuestas"]->setEvaluacion($core["evaluaciones"]->getEvaluacion());
                                $core["respuestas"]->setPregunta($pregunta["pregunta"]);
                                $listado_respuestas = $core["respuestas"]->ListadoTotal();
                                
                                foreach ($listado_respuestas as $indice => $respuesta) {
                            ...
                            ?>
                                ...
                                <tr>
                                    <td class="opciones">
                                        ...
                                        <?PHP if (count($listado_respuestas) != $respuesta["respuesta"]) { ?>
                                            <a href="respuesta_bajar.php?evaluacion=<?PHP echo $core["evaluaciones"]->getEvaluacion(); ?>&pregunta=<?PHP echo $pregunta["pregunta"]; ?>&respuesta=<?PHP echo $respuesta["respuesta"]; ?>"><img src="../../../../imgs/evaluaciones/bajar.png" alt="Bajar Respuesta" title="Bajar Respuesta" /></a>
                                        <?PHP } else { ?>
                                            <img src="../../../../imgs/evaluaciones/espaciar.png" />
                                        <?PHP } ?>
                                        
                                        <?PHP if ($respuesta["respuesta"] != 1) { ?>
                                            <a href="respuesta_subir.php?evaluacion=<?PHP echo $core["evaluaciones"]->getEvaluacion(); ?>&pregunta=<?PHP echo $pregunta["pregunta"]; ?>&respuesta=<?PHP echo $respuesta["respuesta"]; ?>"><img src="../../../../imgs/evaluaciones/subir.png" alt="Subir Respuesta" title="Subir Respuesta" /></a>
                                        <?PHP } else { ?>
                                            <img src="../../../../imgs/evaluaciones/espaciar.png" />
                                        <?PHP } ?>
                                        
                                        <a href="respuesta_editar.php?evaluacion=<?PHP echo $core["evaluaciones"]->getEvaluacion(); ?>&pregunta=<?PHP echo $pregunta["pregunta"]; ?>&respuesta=<?PHP echo $respuesta["respuesta"]; ?>"><img src="../../../../imgs/evaluaciones/editar.png" alt="Editar Respuesta" title="Editar Respuesta" /></a>
                                        
                                        <?PHP if ($respuesta["activo"] == "X") { ?>
                                            <a href="respuesta_desactivar.php?evaluacion=<?PHP echo $core["evaluaciones"]->getEvaluacion(); ?>&pregunta=<?PHP echo $pregunta["pregunta"]; ?>&respuesta=<?PHP echo $respuesta["respuesta"]; ?>"><img src="../../../../imgs/evaluaciones/desactivar.png" alt="Desactivar Respuesta" title="Desactivar Respuesta" /></a>
                                        <?PHP } else { ?>
                                            <a href="respuesta_activar.php?evaluacion=<?PHP echo $core["evaluaciones"]->getEvaluacion(); ?>&pregunta=<?PHP echo $pregunta["pregunta"]; ?>&respuesta=<?PHP echo $respuesta["respuesta"]; ?>"><img src="../../../../imgs/evaluaciones/activar.png" alt="Activar Respuesta" title="Activar Respuesta" /></a>
                                        <?PHP } ?>
                                    ...
                                    <td class="contador">
                                        <?PHP echo $pregunta["pregunta"] . "." . $respuesta["respuesta"]; ?>
                                    </td>

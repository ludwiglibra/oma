	...
	<div class="homeCont">
    	...
    	<?PHP if ($sesion_registrada) { ?>
            ...
            <div class="izquierda">                
                ...
                <h1>Agregar Pregunta a la Evaluación <strong><?PHP echo strtoupper($evaluacion_seleccionada); ?></strong></h1>
                <form name="frmAgregar" method="post" action="pregunta_insertar.php">

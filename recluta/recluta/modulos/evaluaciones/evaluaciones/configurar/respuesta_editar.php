	...
	<div class="homeCont">
    	...
    	<?PHP if ($sesion_registrada) { ?>
            ...
            <div class="izquierda">                
                ...
                <form name="frmDetalles" method="post" action="respuesta_actualizar.php">
				<table class="detalles">
                    <tbody>
                        ...
                        <tr>
                            <td class="obligatorio">* ID Respuesta</td>
                            <td class="campo"><input type="text" name="respuesta" value="<?PHP echo $core["respuestas"]->getRespuesta(); ?>" size="50" maxlength="100" readonly="readonly" class="llave" /></td>
                        </tr>
                        <tr>
                            <td class="obligatorio">* Texto de la Respuesta</td>
                            <td class="campo"><textarea name="texto" cols="60" rows="8"><?PHP echo $core["respuestas"]->getTexto(); ?></textarea></td>
                        </tr>
                        <tr>

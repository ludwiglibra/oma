<?PHP
	...
	if ($evaluacion_seleccionada != "") {
		...
		if ($core["evaluaciones"]->Existe($evaluacion_seleccionada)) {
			...
			$core["notas"]->setValor1($evaluacion_seleccionada);
    	...
    	<?PHP if ($sesion_registrada) { ?>
            ...
            <div class="izquierda">                
                <div class="contenido">
                  ...
                  <h1>Detalles de Evaluación <strong><?PHP echo strtoupper($evaluacion_seleccionada); ?></strong></h1>
                    ...
                    <table class="detalles">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="campo"><input type="text" name="titulo" value="<?PHP echo $core["evaluaciones"]->getTitulo(); ?>" size="50" maxlength="100" /></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">* Descripción</td>
                                <td class="campo"><textarea name="descripcion" cols="60" rows="8"><?PHP echo $core["evaluaciones"]->getDescripcion(); ?></textarea></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">Vacante Activa</td>
                                <td class="campo">
                                    <?PHP if ($core["evaluaciones"]->getActivo() == "X") { ?>
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="2">
                                    ...
                                    <input type="button" name="btnConfigurar" value="Configurar" onclick=Configurar(this.form); />
                ...
                <table class="reportes">
                    ...
                    <tfoot>
                    	<tr>
                        	<td colspan="3">
                                <input type="hidden" name="evaluacion" value="<?PHP echo $evaluacion_seleccionada; ?>" />

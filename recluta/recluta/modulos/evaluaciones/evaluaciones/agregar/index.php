<?PHP
	...
	$campo_evaluacion = $core["sesion"]->getVariable("campo_evaluacion");
    	...
    	<?PHP if ($sesion_registrada) { ?>
            ...
            <div class="izquierda">                
                <div class="contenido">
                  ...
                  <h1>Agregar Evaluación Técnica</h1>
                  <form name="frmAgregar" method="post" action="agregar.php">
                    <table class="detalles">
                        <tbody>
                            <tr>
                                <td class="obligatorio">* ID Evaluación</td>
                                <td class="campo"><input type="text" name="evaluacion" value="<?PHP echo $campo_evaluacion; ?>" size="50" /></td>
                            </tr>
                            <tr>
            ...
            <div class="derecha">
            	<div class="opciones">
                    ...
                    <h1>Instrucciones</h1>
                    <ol>
                    	<li>Indique el ID, título y descripción de la Evaluación Técnica.</li>
                        <li>Haga click en el botón <strong>AGREGAR</strong> para almacenar la información de la nueva Evaluación Técnica o en el botón <strong>CANCELAR</strong> para volver al listado de Evaluaciones Técnicas almacenadas.</li>
                    </ol>
					<!-- InstanceEndEditable -->
                </div>
            </div>

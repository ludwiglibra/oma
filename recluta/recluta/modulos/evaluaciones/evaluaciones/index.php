<?PHP
	...
	$listado_evaluaciones = $core["evaluaciones"]->ListadoTotal($busqueda);
            ...
            <div class="izquierda">                
                <div class="contenido">
                  <!-- InstanceBeginEditable name="Contenido" -->
                        <h1>Evaluaciones Técnicas del Sistema</h1>
                        ...
                        <table class="reportes">
                            ...
                            <tbody>
                            	<?PHP foreach ($listado_evaluaciones as $indice => $elemento) { ?>
                                    <tr>
                                        <td><?PHP echo $indice + 1; ?></td>
                                        <td><a href="abrir.php?evaluacion=<?PHP echo $elemento["evaluacion"]; ?>"><?PHP echo $elemento["evaluacion"]; ?></a></td>
            ...
            <div class="derecha">
            	<div class="opciones">
                    <!-- InstanceBeginEditable name="Opciones" -->
                        <h1>Instrucciones</h1>
                        <ol>
                        	<li>Haga click sobre el botón <strong>AGREGAR</strong> para agregar una nueva Evaluación Técnica, o</li>
                            <li>Haga click sobre un ID de Evaluación Técnica, para abrir los detalles relacionados a ella.</li>
                        </ol>
						<!-- InstanceEndEditable -->
                </div>
            </div>

<?PHP
	...
	$listado_baterias = $core["baterias"]->ListadoUsuario($sesion_usuario, $busqueda);
                ...
                <div class="contenido">
                  <!-- InstanceBeginEditable name="Contenido" -->
                        ...
                        <table class="reportes">
                            ...
                            <tbody>
                            	<?PHP foreach ($listado_baterias as $indice => $elemento) { ?>
                                    <tr>
                                        <td><?PHP echo $indice + 1; ?></td>
                                        <td><a href="abrir.php?bateria=<?PHP echo $elemento["bateria"]; ?>"><?PHP echo $elemento["bateria"]; ?></a></td>

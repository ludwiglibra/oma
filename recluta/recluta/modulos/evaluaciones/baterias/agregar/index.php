<?PHP
	...
	$campo_bateria = $core["sesion"]->getVariable("campo_bateria");
    	...
    	<?PHP if ($sesion_registrada) { ?>
            ...
            <div class="izquierda">                
                <div class="contenido">
                  ...
                  <h1>Agregar Batería de Evaluaciones</h1>
                  <form name="frmAgregar" method="post" action="agregar.php">
                    <table class="detalles">
                        <tbody>
                            <tr>
                                <td class="obligatorio">* ID Batería</td>
                                <td class="campo"><input type="text" name="bateria" value="<?PHP echo $campo_bateria; ?>" size="50" /></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="campo"><textarea name="descripcion" cols="60" rows="8"><?PHP echo $campo_descripcion; ?></textarea></td>
                            </tr>
                            <tr>
            ...
            <div class="derecha">
            	<div class="opciones">
                    ...
                    <h1>Instrucciones</h1>
                    <ol>
                    	<li>Indique el ID, título y descripción de la Batería de Evaluaciones.</li>
                        <li>Seleccione el área de la organización para la cual esta Batería de Evaluaciones estará disponible.</li>
                        <li>Haga click en el botón <strong>AGREGAR</strong> para almacenar la información de la nueva Batería de Evaluaciones o en el botón <strong>CANCELAR</strong> para volver al listado de Baterías de Evaluaciones almacenadas.</li>
                    </ol>
					<!-- InstanceEndEditable -->
                </div>
            </div>

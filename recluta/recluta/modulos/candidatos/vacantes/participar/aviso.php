    	...
    	<?PHP if ($sesion_registrada) { ?>
            ...
            <div class="izquierda">                
                <div class="contenido">
                  ...
                  <form name="frmAviso" method="post" action="aceptar_aviso.php">
                  	<input type="hidden" name="pagina" value="<?PHP echo $pagina; ?>" />
                    <table class="detalles">
                        <tbody>
                            <tr>
                                <td colspan="2"><textarea name="aviso" cols="80" rows="20" readonly="readonly"><?PHP echo $core["parametros"]->getAviso(); ?></textarea></td>
                            </tr>
                        </tbody>
                        <tfoot>
                            <tr>
                                <td colspan="2">
                                    ...
                                    <input type="button" name="btnRechazar" value="Rechazar" onclick=Rechazar("<?PHP echo $pagina; ?>"); />
                                </td>
                            </tr>
                        </tfoot>
                    </table>
            ...
            <div class="derecha">
            	<div class="opciones">
                    ...
                    <h1>Instrucciones</h1>
                    <ol>
                    	<li>Lea las claúsulas del aviso de privacidad y dé click en el botón <strong>ACEPTAR</strong> para dar su consentimiento a las mismas.</li>
                    </ol>
					<!-- InstanceEndEditable -->
                </div>
            </div>

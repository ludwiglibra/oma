<?PHP
	...
	$vacante_aplicando = $core["sesion"]->getVariable("vacante_aplicando");
	
	if ($vacante_aplicando != "") {
			
		if ($core["vacantes"]->Vigente($vacante_aplicando)) {
			
			$core["vacantes"]->setVacante($vacante_aplicando);
			...
			$core["archivos"]->setValor1($vacante_aplicando);
			$listado_archivos = $core["archivos"]->Listado();
			
		} else {
			$core["sesion"]->setMensaje("La vacante indicada no está vigente.");
    	...
    	<?PHP if ($sesion_registrada) { ?>
            ...
            <div class="izquierda">                
                <div class="contenido">
                  ...
                  <h1>Detalles de Vacante <strong><?PHP echo strtoupper($vacante_aplicando); ?></strong></h1>
                  
                  <?PHP 
				  
				  	$datos_vacante = $core["vacantes"]->DatosGenerales($vacante_aplicando);
				  
				  ?>
                  
                    <table class="detalles2">
                        <tbody>
                        	<tr>
                                <td class="obligatorio">ID Vacante</td>
                                <td class="campo"><label><?PHP echo $datos_vacante["vacante"]; ?></label></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">Tipo de Vacante</td>
                                <td class="campo"><label><?PHP echo $datos_vacante["tipo"]; ?></label></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">Ubicación</td>
                                <td class="campo"><label><?PHP echo $datos_vacante["ubicacion"]; ?></label></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">Área</td>
                                <td class="campo"><label><?PHP echo $datos_vacante["area"]; ?></label></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">Título</td>
                                <td class="campo"><label><?PHP echo $datos_vacante["titulo"]; ?></label></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">Descripción</td>
                                <td class="campo"><label><?PHP echo $datos_vacante["descripcion"]; ?></label></td>
                            </tr>
                            <?PHP if ($core["vacantes"]->getAnexo() != "") { ?>
                          <tr>
                            <td class="obligatorio">Anexo</td>
                                    <td class="campo"><a href="../../../bolsa/vacantes/anexos/<?PHP echo $datos_vacante["anexo"]; ?>" target="_blank">
                                      <label><?PHP echo $datos_vacante["anexo"]; ?></label>
                              </a></td>
                          </tr>
                            <?PHP } ?>
                            <tr>
                                <td class="obligatorio">Formación</td>
                                <td class="campo"><label><?PHP echo $datos_vacante["formacion"]; ?></label></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">Conocimientos</td>
                                <td class="campo"><label><?PHP echo $datos_vacante["conocimientos"]; ?></label></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">Experiencia</td>
                                <td class="campo"><label><?PHP echo $datos_vacante["experiencia"]; ?></label></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">Funciones</td>
                                <td class="campo"><label><?PHP echo $datos_vacante["funciones"]; ?></label></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">Competencias</td>
                                <td class="campo"><label><?PHP echo $datos_vacante["competencias"]; ?></label></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">Discapacidades</td>
                                <td class="campo"><label><?PHP echo $datos_vacante["discapacidades"]; ?></label></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">Inicio</td>
                                <td class="campo"><label><?PHP echo $datos_vacante["inicio"]; ?></label></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">Fin</td>
                                <td class="campo"><label><?PHP echo $datos_vacante["fin"]; ?></label></td>
                            </tr>
                        </tbody>
                        <tfoot>
                            <tr>
                                <td colspan="2">
                                	<input type="button" name="btnParticipar" value="Participar" onclick=Participar(this.form); />
                                    <input type="button" name="btnCerrar" value="Cerrar" onclick=Cerrar(this.form); />
                                </td>
                            </tr>
                        </tfoot>
                    </table>
                ...
                <table class="reportes">
                    ...
                    <tbody>
                    	...
                    	<tr>
                            ...
                            <td><a href="../../../../adjuntos/<?PHP echo $elemento["archivo"] ?>" target="_blank"><?PHP echo $elemento["archivo"] ?></a></td>
                        </tr>
                        <?PHP } ?>
                    </tbody>
                </table>
            ...
            <div class="derecha">
            	<div class="opciones">
                    ...
                    <h1>Instrucciones</h1>
                    <ol>
                    	<li>Revise la información de la vacante y presione <strong>CERRAR</strong> cuando quiera volver al listado de vacantes disponibles.</li>
                    </ol>
					<!-- InstanceEndEditable -->
                </div>
            </div>

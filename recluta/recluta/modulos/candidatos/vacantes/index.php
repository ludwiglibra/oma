<?PHP
	...
	$core["sesion"]->setVariable("vacante_aplicando", "");
	
	$busqueda = (isset($_POST["busqueda"]) && $_POST["busqueda"] != "") ? $_POST["busqueda"] : "";
	
	//$listado_vacantes = $core["vacantes"]->ListadoVigentes();
	$ordenamiento = (isset($_GET["sort"]) && $_GET["sort"] != "") ? $_GET["sort"] : "";
	$listado_vacantes = $core["vacantes"]->ListadoVigentes("", $busqueda, $ordenamiento);
	...
	$existe_generales = false;	
	if (!($core["generales"]->Existe($candidato))) {
		$existe_generales = true;
	}
	...
	} elseif (!($core["estudios"]->Existe($candidato, 1))) {
		$existe_candidato = false;
                  ...
                  <!-- InstanceBeginEditable name="Contenido" -->
                        ...
                        <table class="filtros">
                        	<tbody>
                            	<tr>
                                	<td>
                                    	<input type="text" name="busqueda" value="" size="60" />
                                        <input type="submit" name="btnBuscar" value="Buscar" />
                                        <input type="button" name="btnTodos" value="Todos" onclick=Todos(this.form); />
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <?PHP if (!($existe_candidato)) { ?>
                        <br />
                        <div class="mensajes">
                          <h2>Cartera de Talento</h2>
                          <p>¡El Equipo de Integración de Personal te da la Bienvenida!</p>
                            <p>Una Gran Empresa para Trabajar la Hace su Gente.</p>
                          <p>Si no encontraste oportunidades de desarrollo de tu interés o perfil, puedes dejarnos tus datos para ser considerado en futuras oportunidades.</p>
                            <p><a href="../../autoservicio/candidato/">Abrir Información de Candidato</a></p>
                        </div>
                        <?PHP } ?>
                        ...
                        <table class="reportes">
                        	<thead>
                            	<tr>
                                	<td>Estatus</td>
                                	<td><a href="index.php?sort=vacante">Vacante</a></td>
                                    <td><a href="index.php?sort=titulo">Nombre</a></td>
                                    <td><a href="index.php?sort=descripcion">Descripción</a></td>
                                    <td><a href="index.php?sort=area">Area</a></td>
                                    <td><a href="index.php?sort=inicio">Inicio</a></td>
                                    <td><a href="index.php?sort=fin">Fin</a></td>
                                </tr>
                            </thead>
                            <tbody>
                            	<?PHP foreach ($listado_vacantes as $indice => $elemento) { ?>
                                    <tr>
                                    	<td>
                                            <?PHP if ($elemento["diferencia"] == 0) { ?>
                                                <img src="../../../imgs/indicadores/rojo.png" />
                                            <?PHP } elseif ($elemento["diferencia"] <= 1) { ?>
                                            	<img src="../../../imgs/indicadores/naranja.png" />
                                            <?PHP } elseif ($elemento["diferencia"] > 1) { ?>
                                            	<img src="../../../imgs/indicadores/verde.png" style="vertical-align: middle" />
                                            <?PHP } ?>
                                        </td>
                                        <td>
                                        	<a href="abrir.php?vacante=<?PHP echo $elemento["vacante"]; ?>"><?PHP echo $elemento["vacante"]; ?></a>
                                        </td>
                                        <td>
                                        	<a href="abrir.php?vacante=<?PHP echo $elemento["vacante"]; ?>"><?PHP echo $elemento["titulo"]; ?></a>
                                        </td>
                                        <td><?PHP echo $elemento["descripcion"]; ?></td>
                                        <td><?PHP echo $elemento["area"]; ?></td>
                                        <td><?PHP echo $elemento["inicio"]; ?></td>
                                        <td><?PHP echo $elemento["fin"]; ?></td>
                                    </tr>
								<?PHP } ?>
                            </tbody>
                        </table>
            ...
            <div class="derecha">
            	<div class="opciones">
                    <!-- InstanceBeginEditable name="Opciones" -->
                        <h1>Instrucciones</h1>
                        <ol>
                        	<li>Haga click en el título de la vacante, para abrir el detalle de la misma.</li>
                        </ol>
                        <em>Los colores indican lo cerca que está la vacante de expirar.</em>
						<!-- InstanceEndEditable -->
                </div>
            </div>
            <div class="clear"></div>

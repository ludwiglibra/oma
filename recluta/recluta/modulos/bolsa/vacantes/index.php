<?PHP
	...
	$listado_vigentes = $core["vacantes"]->ListadoVigentes($sesion_usuario, $busqueda);
	$listado_futuras = $core["vacantes"]->ListadoFuturas($sesion_usuario, $busqueda);
	$listado_pasadas = $core["vacantes"]->ListadoPasadas($sesion_usuario, $busqueda);
                  ...
                  <!-- InstanceBeginEditable name="Contenido" -->
                        ...
                        <table class="filtros">
                        	<tbody>
                            	<tr>
                                	<td>
                                    	<input type="text" name="busqueda" value="" size="40" />
                                        <input type="submit" name="btnBuscar" value="Buscar" />
                                        <input type="button" name="btnTodos" value="Todos" onclick=Todos(this.form); />
                                        <input type="button" name="btnAgregar" value="Agregar" onclick=Agregar(this.form); />
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="reportes">
                            ...
                            <tbody>
                            	<?PHP foreach ($listado_vigentes as $indice => $elemento) { ?>
                                    <tr>
                                        <td><?PHP echo $indice + 1; ?></td>
                                        <td><a href="abrir.php?vacante=<?PHP echo $elemento["vacante"]; ?>"><?PHP echo $elemento["vacante"]; ?></a></td>
                                        <td><?PHP echo $elemento["titulo"]; ?></td>
                                        <td><a href="../../administracion/areas/abrir.php?area=<?PHP echo $elemento["area"]; ?>"><?PHP echo $elemento["area"]; ?></a></td>
                                        <td><?PHP echo $elemento["inicio"]; ?></td>
                                        <td><?PHP echo $elemento["fin"]; ?></td>
                                        <td><?PHP echo $elemento["activo"]; ?></td>
                                    </tr>
								<?PHP } ?>
                            </tbody>
                        </table>
                        <br />
                        <h1>Vacantes Futuras</h1>
                        <table class="reportes">
                        	<thead>
                            	<tr>
                                	<td>#</td>
                            ...
                            <tbody>
                            	<?PHP foreach ($listado_futuras as $indice => $elemento) { ?>
                                    <tr>
                                        <td><?PHP echo $indice + 1; ?></td>
                                        <td><a href="abrir.php?vacante=<?PHP echo $elemento["vacante"]; ?>"><?PHP echo $elemento["vacante"]; ?></a></td>
                                        <td><?PHP echo $elemento["titulo"]; ?></td>
                        ...
                        <table class="reportes">
                            ...
                            <tbody>
                            	<?PHP foreach ($listado_pasadas as $indice => $elemento) { ?>
                                    <tr>
                                        <td><?PHP echo $indice + 1; ?></td>
                                        <td><a href="abrir.php?vacante=<?PHP echo $elemento["vacante"]; ?>"><?PHP echo $elemento["vacante"]; ?></a></td>
                                        <td><?PHP echo $elemento["titulo"]; ?></td>
            ...
            <div class="derecha">
            	<div class="opciones">
                    <!-- InstanceBeginEditable name="Opciones" -->
                        <h1>Instrucciones</h1>
                        <ol>
                        	<li>Haga click sobre el botón AGREGAR para agregar una nueva vacante, o</li>
                            <li>Haga click sobre un ID de vacante, para abrir los detalles relacionados a ella.</li>
                        </ol>
						<!-- InstanceEndEditable -->
                </div>
            </div>

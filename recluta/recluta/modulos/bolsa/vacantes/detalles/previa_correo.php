<?PHP
	...
	if ($vacante != "" && $candidato != "") {
		...
		$mensaje = $core["parametros"]->getAgradecimiento();
		
		$mensaje = str_replace("%candidato%", strtoupper($core["generales"]->getNombres() . " " . $core["generales"]->getApellidos()), $mensaje);
		$mensaje = str_replace("%puesto%", strtoupper($core["vacantes"]->getTitulo()), $mensaje);
		
	} else {
		$core["sesion"]->setMensaje("No existen las condiciones mínimas para presentar la vista previa de correo a Candidato");
    	...
    	<?PHP if ($sesion_registrada) { ?>
            ...
            <div class="izquierda">                
                <div class="contenido">
                  ...
                  <h1>Vista Previa de Correo</h1>
                  <form name="frmPrevia" method="post" action="envio_correo.php">
                    ...
                    <table class="detalles">
                        <tbody>
                        	<tr>
                                ...
                                <td class="campo"><input type="text" name="vacante" value="<?PHP echo $core["vacantes"]->getVacante() . " - " . $core["vacantes"]->getTitulo(); ?>" size="50" maxlength="100" readonly="readonly" class="llave" /></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">Candidato</td>
                                <td class="campo"><input type="text" name="candidato" value="<?PHP echo $core["generales"]->getUsuario() . " - " . $core["generales"]->getNombres() . " " . $core["generales"]->getApellidos(); ?>" size="50" maxlength="100" readonly="readonly" class="llave" /></td>
                            </tr>
                            <tr>
                            	<td class="obligatorio">Mensaje</td>
                                <td class="campo"><textarea name="mensaje" cols="78" rows="15"><?PHP echo $mensaje; ?></textarea></td>
                            </tr>
                        </tbody>
                        <tfoot>
                            <tr>
                                <td colspan="2">
                                    ...
                                    <input type="button" name="btnCancelar" value="Cancelar" onclick=Cerrar(this.form); />
                                </td>
                            </tr>
                        </tfoot>
                    </table>

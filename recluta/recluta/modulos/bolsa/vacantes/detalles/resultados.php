<?PHP
	...
	$listado_respuestas = $core["candidatos"]->ListadoRespuestas($candidato, $vacante);
	...
	<div class="homeCont">
    	...
    	<?PHP if ($sesion_registrada) { ?>
            ...
            <div class="izquierda">                
                ...
                <h1>Calificaciones Candidato <?PHP echo $candidato; ?> en Vacante <?PHP echo $vacante; ?></h1>
				<table class="reportes">
                    ...
                    <tbody>
                    	<?PHP foreach ($listado_respuestas as $indice_respuesta => $respuesta) { ?>
                    	<tr>
                            <td><?PHP echo $respuesta["bateria_sec"]; ?></td>
                            <td><?PHP echo $respuesta["bateria"]; ?></td>
                            <td><?PHP echo $respuesta["evaluacion_sec"]; ?></td>
                            <td><?PHP echo $respuesta["evaluacion"]; ?></td>
                            <td><?PHP echo $respuesta["pregunta"]; ?></td>
                            <td><?PHP echo $respuesta["pregunta_txt"]; ?></td>
                            <td><?PHP echo $respuesta["respuesta"]; ?></td>
                            <td><?PHP echo $respuesta["respuesta_txt"]; ?></td>
                            <td><?PHP echo round(($respuesta["valor"] / 100),2); ?></td>
                            
                            <?PHP
							
								$acumulador = $acumulador + round(($respuesta["valor"] / 100),2);
                        ...
                        <?PHP } ?>
                        <tr>
                            <td colspan="8">Calificación Total de las Evaluaciones</td>

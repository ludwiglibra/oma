<?PHP
	...
	$campo_tipo = $core["sesion"]->getVariable("campo_tipo");
	$campo_ubicacion = $core["sesion"]->getVariable("campo_ubicacion");
	$campo_area = $core["sesion"]->getVariable("campo_area");
	$campo_titulo = $core["sesion"]->getVariable("campo_titulo");
	$campo_descripcion = $core["sesion"]->getVariable("campo_descripcion");
	$campo_anexo = $core["sesion"]->getVariable("campo_anexo");
	$campo_formacion = $core["sesion"]->getVariable("campo_formacion");
	$campo_conocimientos = $core["sesion"]->getVariable("campo_conocimientos");
	$campo_experiencia = $core["sesion"]->getVariable("campo_experiencia");
	$campo_funciones = $core["sesion"]->getVariable("campo_funciones");
	$campo_competencias = $core["sesion"]->getVariable("campo_competencias");
	$campo_discapacidades = $core["sesion"]->getVariable("campo_discapacidades");
	$campo_inicio = $core["sesion"]->getVariable("campo_inicio");
	$campo_fin = $core["sesion"]->getVariable("campo_fin");
    	...
    	<?PHP if ($sesion_registrada) { ?>
            ...
            <div class="izquierda">                
                <div class="contenido">
                  ...
                  <form name="frmUsuario" method="post" action="agregar.php" enctype="multipart/form-data">
                    <table class="detalles">
                        <tbody>
                            <tr>
                                <td class="obligatorio">* ID de Vacante</td>
                                <td class="campo"><input type="text" name="vacante" value="POR DEFINIR" size="50" readonly="readonly" class="llave" /></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="campo"><textarea name="ubicacion" cols="50" rows="5"><?PHP echo $campo_ubicacion; ?></textarea></td>
                            </tr>
							<tr>
                                ...
                                <td class="campo">
                                    <select name="area">
                                        ...
                                        <?PHP foreach ($listado_areas as $indice => $elemento) { ?>
                                        	<?PHP if ($campo_area == $elemento["area"]) { ?>
                            ...
                            <tr>
                                ...
                                <td class="campo"><input type="text" name="titulo" value="<?PHP echo $campo_titulo; ?>" size="50" maxlength="100" /></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">* Descripción General del Puesto</td>
                                <td class="campo"><textarea name="descripcion" cols="50" rows="5"><?PHP echo $campo_descripcion; ?></textarea></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">Descripción de Puesto Anexa</td>
                                <td class="campo"><input type="file" name="anexo" /></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">* Formación Académica</td>
                                <td class="campo"><textarea name="formacion" cols="50" rows="5"><?PHP echo $campo_formacion; ?></textarea></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">* Conocimientos Requeridos</td>
                                <td class="campo"><textarea name="conocimientos" cols="50" rows="5"><?PHP echo $campo_conocimientos; ?></textarea></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">* Experiencia Profesional</td>
                                <td class="campo"><textarea name="experiencia" cols="50" rows="5"><?PHP echo $campo_experiencia; ?></textarea></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">* Funciones del Puesto</td>
                                <td class="campo"><textarea name="funciones" cols="50" rows="5"><?PHP echo $campo_funciones; ?></textarea></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">* Competencias y Habilidades Requeridas</td>
                                <td class="campo"><textarea name="competencias" cols="50" rows="5"><?PHP echo $campo_competencias; ?></textarea></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">Tipo de discapacidad aceptable</td>
                                <td class="campo"><textarea name="discapacidades" cols="50" rows="5"><?PHP echo $campo_discapacidades; ?></textarea></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">* Inicio de Validez</td>
                                <td class="campo"><input type="text" id="datepicker_inicio" name="inicio" value="<?PHP echo $campo_inicio; ?>" size="10" maxlength="10" readonly="readonly" /></td>
                            </tr>
                            <tr>
                                <td class="obligatorio">* Fin de Validez</td>
                                <td class="campo"><input type="text" id="datepicker_fin" name="fin" value="<?PHP echo $campo_fin; ?>" size="10" maxlength="10" readonly="readonly" /></td>
                            </tr>
                        </tbody>
                        <tfoot>
                            <tr>
            ...
            <div class="derecha">
            	<div class="opciones">
                    ...
                    <h1>Instrucciones</h1>
                    <ol>
                    	<li>Indique el título de la vacante, el número de la misma es calculado de forma automática.</li>
                        <li>Introduzca la descripción de la misma, en forma de un resumen que permita tener un contexto completo de ella.</li>
                        <li>Describa los requisitos que deben cumplirse para poder aspirar a la vacante ofertada.</li>
                        <li>Elija el área de la organización donde deberá catalogarse, para efectos de las evaluaciones que deberán aplicarse.</li>
                        <li>Indique fecha de inicio y de fin de la vacante, para que el sistema sepa cuando mostrarlas y hasta cuando poder recibir evaluaciones.</li>
                        <li>Haga click en el botón <strong>AGREGAR</strong> para almacenar la información introducida o en <strong>CANCELAR</strong>, para volver al listado de vacantes existentes en el sistema</li>
                    </ol>
					<!-- InstanceEndEditable -->
                </div>
            </div>

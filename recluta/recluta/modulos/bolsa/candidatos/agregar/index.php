    	...
    	<?PHP if ($sesion_registrada) { ?>
            ...
            <div class="izquierda">                
                <div class="contenido">
                  ...
                  <form name="frmCandidato" method="post" action="agregar.php">
                    	<table class="detalles">
                        	<tbody>
                            	<tr>
                                	<td class="obligatorio">* ID Candidato</td>
                                    <td class="campo"><input type="text" name="usuario" value="" size="50" maxlength="50" /></td>
                                </tr>
                                <tr>
                                	<td class="obligatorio">* Clave de Acceso</td>
                                    <td class="campo"><input type="password" name="clave" value="" size="50" maxlength="50" /></td>
                                </tr>
                            </tbody>
                            <tfoot>
                            	<tr>
            ...
            <div class="derecha">
            	<div class="opciones">
                    ...
                    <h1>Instrucciones</h1>
                    <ol>
                    	<li>Indique el ID del Candidato que desea agregar.</li>
                        <li>Introduzca la clave que tendrá el Candidato para el acceso al sistema.</li>
                    	<li>Proporcione nombre y correo electrónico.</li>
                        <li>Haga click en el botón <strong>AGREGAR</strong> para crear el Candidato o en el botón <strong>CANCELAR</strong> para regresar al listado de Candidatos.</li>
                    </ol>
					<!-- InstanceEndEditable -->
                </div>
            </div>

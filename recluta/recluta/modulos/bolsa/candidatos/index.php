<?PHP
	...
	$core["sesion"]->setVariable("usuario_seleccionado", "");
	
	$busqueda = (isset($_POST["busqueda"]) && $_POST["busqueda"] != "") ? $_POST["busqueda"] : "";
	
	$listado_usuarios = $core["usuarios"]->ListadoCandidatos($busqueda);
                        ...
                        <table class="reportes">
                            ...
                            <tbody>
                            	<?PHP foreach ($listado_usuarios as $indice => $elemento) { ?>
                                	<?PHP if ($elemento["usuario"] != $core["parametros"]->getAdministrador() && $elemento["usuario"] != $sesion_usuario) { ?>
                                        <tr>
                                            <td><?PHP echo $indice + 1; ?></td>
                                            <td><a href="abrir.php?usuario=<?PHP echo $elemento["usuario"]; ?>"><?PHP echo $elemento["usuario"]; ?></a></td>
                                            <td><?PHP echo $elemento["nombre"]; ?></td>
                                            <td><?PHP echo $elemento["nivel"]; ?></td>
                                            <td><?PHP echo $elemento["vacantes"]; ?></td>
            ...
            <div class="derecha">
            	<div class="opciones">
                    <!-- InstanceBeginEditable name="Opciones" -->
                        <h1>Instrucciones</h1>
                        <ol>
                        	<li>Haga click sobre el botón <strong>AGREGAR</strong> para agregar un nuevo Candidato, o</li>
                            <li>Haga click sobre un nombre del Candidato, para abrir los detalles del mismo.</li>
                        </ol>
						<!-- InstanceEndEditable -->
                </div>
            </div>

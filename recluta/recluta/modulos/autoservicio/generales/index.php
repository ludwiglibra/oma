<?PHP
	...
	$core["generales"]->setUsuario($sesion_usuario);
            ...
            <div class="izquierda">                
                <div class="contenido">
                  <!-- InstanceBeginEditable name="Contenido" -->
                        <h1>Datos Generales de Usuario</h1>
                        
                        <?PHP
							$avatar = $sesion_usuario . ".jpg";
						?>
                        <table class="avatares">
                        	<tbody>
                            	<tr>
                                	<td class="botones">
                                    	<form name="frmAvatares" method="post" action="adjuntar.php" enctype="multipart/form-data">
                                        	<input type="file" name="archivo" size="20" />
                                            <input type="submit" name="btnAdjuntar" value="Adjuntar" />
                                        </form>
                                    </td>
                                    <td class="imagen">
                                    	<?PHP if (file_exists("avatares\\" . $avatar)) { ?>
                                        	<img src="avatares\<?PHP echo $avatar; ?>" width="100" height="100" />
                                        <?PHP } else { ?>
                                        	<img src="avatares\desconocido.png" width="100" height="100" />
                                        <?PHP } ?>
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <input type="hidden" name="usuario" value="<?PHP echo $sesion_usuario; ?>" />
                        <input type="hidden" name="vacante" value="<?PHP echo $vacante; ?>" />
                    	<table class="detalles">
                        	<tbody>
                            	<tr>
                                	<td class="obligatorio">* Nombre(s)</td>
                                    <td class="campo"><input type="text" name="nombres" value="<?PHP echo $core["generales"]->getNombres(); ?>" size="70" maxlength="200" /></td>
                                </tr>
                                <tr>
                                	<td class="obligatorio">* Apellido(s)</td>
                                    <td class="campo"><input type="text" name="apellidos" value="<?PHP echo $core["generales"]->getApellidos(); ?>" size="70" maxlength="200" /></td>
                                </tr>
                                <tr>
                                	<td class="obligatorio">Teléfono Celular</td>
                                    <td class="campo">
                                    	<input type="text" name="prefcelular" value="<?PHP echo $core["generales"]->getPrefcelular(); ?>" size="5" maxlength="10" />
                                        <input type="text" name="celular" value="<?PHP echo $core["generales"]->getCelular(); ?>" size="20" maxlength="100" />
                                    </td>
                                </tr>
                                <tr>
                                	<td class="obligatorio">Teléfono Fijo</td>
                                    <td class="campo">
                                    	<input type="text" name="preffijo" value="<?PHP echo $core["generales"]->getPreffijo(); ?>" size="5" maxlength="10" />
                                        <input type="text" name="fijo" value="<?PHP echo $core["generales"]->getFijo(); ?>" size="20" maxlength="100" />
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="campo"><input type="text" id="datepicker_nacimiento" name="nacimiento" value="<?PHP echo $core["generales"]->getNacimiento(); ?>" size="10" maxlength="10" readonly="readonly" /></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="campo"><textarea name="domicilio" cols="50" rows="5"><?PHP echo $core["generales"]->getDomicilio(); ?></textarea></td>
                                </tr>
                            </tbody>
                            <tfoot>
                            	<tr>
            ...
            <div class="derecha">
            	<div class="opciones">
                    <!-- InstanceBeginEditable name="Opciones" -->
                        <h1>Instrucciones</h1>
                        <ol>
                        	<li>Ingrese los campos solicitados y haga clic en el botón <strong>ACTUALIZAR</strong>.</li>
                        </ol>

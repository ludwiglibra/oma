                    	...
                    	<table class="detalles">
                        	<tbody>
                            	<tr>
                                    ...
                                    <td class="campo">
                                    	<input type="text" name="titulo" value="<?PHP echo $core["experiencias"]->getTitulo(); ?>" size="70" maxlength="100" />
                                    </td>
                                </tr>
                                <tr>
                                	<td class="obligatorio">Empresa</td>
                                    <td class="campo"><input type="text" name="empresa" value="<?PHP echo $core["experiencias"]->getEmpresa(); ?>" size="70" maxlength="100" /></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="campo"><input type="text" name="area" value="<?PHP echo $core["experiencias"]->getArea(); ?>" size="70" maxlength="100" /></td>
                                </tr>
                                <tr>
                                	<td class="obligatorio">Sub-Area</td>
                                    <td class="campo"><input type="text" name="subarea" value="<?PHP echo $core["experiencias"]->getSubarea(); ?>" size="70" maxlength="100" /></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="campo"><textarea name="responsabilidades" cols="70" rows="10"><?PHP echo $core["experiencias"]->getResponsabilidades(); ?></textarea></td>
                                </tr>
                            </tbody>
                            <tfoot>
                            	<tr>

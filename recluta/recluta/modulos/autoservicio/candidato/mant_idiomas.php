<?PHP
	...
	$listado_secuencias = $core["idiomas"]->ListadoSecuencias($candidato);
				...
				?>
					...
					?>
                        ...
                        <form name="frmIdiomas" method="post" action="actualizar_idiomas.php">
                            <input type="hidden" name="secuencia" value="<?PHP echo $core["idiomas"]->getSecuencia(); ?>" />
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <input type="button" name="btnEliminar" value="Eliminar" onclick=EliminarIdioma(this.form); />
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
                        ...
                        <table class="detalles">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="campo">
                                        <select name="idioma">
											<?PHP foreach ($listado_idiomas as $indice_idioma => $idioma) { ?>
                                                <option value="<?PHP echo $idioma["idioma"]; ?>"><?PHP echo $idioma["descripcion"]; ?></option>
                                            <?PHP } ?>
                                        </select>
                                    </td>

...
<div class="header-wrap">
	<div class="header">
		<a href="../../../index.php"><img src="../../../images/oma-logo.png"/></a>
		<div class="wel-nav">
			<div class="welcome">
                    ...
                    <div class="nav">
                        ...
                        <div class="inicioHover">
                            ...
                            <div class="inicioSubmenu navSub">
                                <a href="../datos/">Mis Datos Personales</a>
                                <a href="../cambio/">Cambio de Contraseña</a>
                                <a href="../accesos/">Accesos al Sistema</a>
                ...
                <div class="contenido">
                  <!-- InstanceBeginEditable name="Contenido" -->
                    	...
                    	<table class="detalles">
                        	<tbody>
                            	<tr>
                                	<td class="obligatorio">* Nombre Completo</td>
                                    <td class="campo"><input type="text" name="nombre" value="<?PHP echo $core["usuarios"]->getNombre(); ?>" size="50" /></td>
                                </tr>
                            	<tr>
                                	<td class="obligatorio">* Correo Electrónico</td>
                                    <td class="campo"><input type="text" name="correo" value="<?PHP echo $core["usuarios"]->getCorreo(); ?>" size="50" /></td>
                                </tr>
                            </tbody>
                            <tfoot>
                            	<tr>

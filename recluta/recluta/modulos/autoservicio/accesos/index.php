<?PHP
	...
	$listado_accesos = $core["listados"]->ListadoAccesosUsuario($sesion_usuario);
	
	$core["sesion"]->setVariable("sesion_reporte", "Accesos del Usuario " . strtoupper($sesion_usuario));
	$core["sesion"]->setVariable("sesion_datos", $listado_accesos);
